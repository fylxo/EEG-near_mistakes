...
class AnalysisConfig:
    ...
    def compute_n_cycles(cls, frequencies):
        ...
        if cls.CYCLES_METHOD == 'fixed':
            ...
            # Custom cycles: Fixed at 5 cycles for all frequencies
            n_cycles = np.full_like(frequencies, 5.0, dtype=float)  # Fixed to 5 cycles
            
            # Previous adaptive approach (commented out):
